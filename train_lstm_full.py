#!/usr/bin/env python3
"""
Chameleon LSTM Full Training Script
====================================

Trains on the complete dataset (41,363 rows) with early stopping.
...
print("=" * 70, flush=True)
print(" CHAMELEON LSTM FULL TRAINING", flush=True)
print("=" * 70, flush=True)
